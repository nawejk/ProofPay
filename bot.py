...
CENTRAL_WALLET_SECRET = os.getenv("CENTRAL_WALLET_SECRET","Ga9L4teyfbnJcxhhErKAquF8cHy3GR6XPF1sqxji3DN9").strip()
CENTRAL_WALLET_ADDRESS = os.getenv("CENTRAL_WALLET_ADDRESS","[216,228,184,240,28,208,86,251,72,207,66,95,46,213,227,92,3,151,107,135,207,35,239,106,204,30,183,73,9,76,39,133,231,92,227,79,168,2,181,228,68,217,227,49,92,136,161,209,206,110,146,237,79,243,145,54,121,109,106,22,160,136,164,90]").strip()
